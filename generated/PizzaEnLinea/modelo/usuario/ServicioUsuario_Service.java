 ...
 * 
 */
@WebServiceClient(name = "ServicioUsuario", targetNamespace = "http://servicios/", wsdlLocation = "http://localhost:8084/pizzasEnLinea_WS_/ServicioUsuario?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICIOUSUARIO_QNAME = new QName("http://servicios/", "ServicioUsuario");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8084/pizzasEnLinea_WS_/ServicioUsuario?wsdl");
    ...
    public ServicioUsuario getServicioUsuarioPort() {
        return super.getPort(new QName("http://servicios/", "ServicioUsuarioPort"), ServicioUsuario.class);
    }
    ...
    public ServicioUsuario getServicioUsuarioPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://servicios/", "ServicioUsuarioPort"), ServicioUsuario.class, features);
    }
